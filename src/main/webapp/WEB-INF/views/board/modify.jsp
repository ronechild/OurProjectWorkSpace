...
<div class="titleWrapper">
	...
	<div class="wrap_jv_header">
	    ...
	    <div class="jv_header" data-rec_idx="48341817" data-rec_seq="0">
	        ...
	        <h1 class="tit_job" >
				<input class="form-control"  style="width: 100%; height: 70px; font-size: 30pt;" name="btitle" id="btitle" value="${recruiterVO.btitle}">
	        </h1>
	    </div>
    </div><%-- 제목 끝--%>
...
<div class="contentBox">
	<form role="form" method="post" name="frmRegister" id="frmRegister" action="${contextPath}/board/detail?bno=${recruiterVO.bno}">
						<%-- ${contextPath}/board/application? --%>
		<%-- 내용 --%>
		<div class="form-group">
			<textarea class="form-control" name="bcontent" id="bcontent" style="height: 500px;" autofocus><c:out value="${recruiterVO.bcontent}"/></textarea>
		</div><%-- 내용 끝 --%>
		<%-- 첨부파일 --%>
