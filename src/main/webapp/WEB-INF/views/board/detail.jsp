...
<div class="cont wrapper" >
   <div class="col">
     ...
     <div class="col">
       <dl>
          <dt>직종&emsp;</dt><dd><c:out value="아무나"/></dd>
      </dl>           
      <dl >
          <dt>지역&emsp;</dt><dd><c:out value="전국"/></dd>
      </dl>
      <dl >
                   ...
                   <p style="margin-bottom: 0px; font-size: 16px;">
                       <strong id="btnStrong" style="padding-top: 2px;">
                           ...
                           <security:authorize access="isAuthenticated()">
                           		<security:authentication property="principal.username" var="usernamefordetail"/>
                                 <button type="button" id="btnRegCmt" class="btn btn-warning btn-sm">댓글 등록</button>
                            </security:authorize>
                            <security:authorize access="hasAnyAuthority('ADMIN','ROLE_MANAGER')">
						    	<security:authentication property="principal.authorities" var="admin"/>
			   				 </security:authorize>
                       </strong>
                   </p>
               </div> <%-- /.panel-heading --%>
...
var myCommentModule = (function() {
 ...
 var scorllReplyStartPagingNum =0;
 var scorllReplyEndPagingNum =5;
 ...
 function showCmtList(){
    myCommentModule.getReplyList(
       ...
       function(replyList){//js callback에 들어감
          ...
          for(var i = scorllReplyStartPagingNum ; i<scorllReplyEndPagingNum ;i++){// 댓글리스트함수 불러와서 재귀함수내에서 myReply로 댓글마다 재귀
        	  saveNum = i;
             ...
             if(myReply.rblind == 0){
               ...
               +   "      <small class='text-muted'>" + myReply.rregDate+ "${myBoard.bwriter}" + "</small>";
                ...
                if( "${usernamefordetail}"==myReply.rwriter||"${admin}" != ""){//어드민이거나 본인만수정삭제기능
                   replyFileInputHtml
          ...
          scorllReplyStartPagingNum = saveNum+1;
          scorllReplyEndPagingNum = saveNum+6;
          replyFileInputHtml 
 ...
 $("#btnRegCmt").on("click",function(){
    ...
    var rwriter ="${usernamefordetail}";//로그인시 헤더에 시큐리티에서 긁어온데이터사용
    ...
    myCommentModule.registerComment(
          ...
          function(result){
             ...
             scorllReplyStartPagingNum=0;
             scorllReplyEndPagingNum=5;
             replyTab.html("")
             showCmtList();
          }
 ...
 $(document).on("click",".btnCmtModifyUpload",function(){
    ...
    scorllReplyStartPagingNum =0;
    scorllReplyEndPagingNum = scorllReplyEndPagingNum-5;
