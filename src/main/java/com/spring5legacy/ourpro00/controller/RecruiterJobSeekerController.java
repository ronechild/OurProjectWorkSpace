...
public class RecruiterJobSeekerController {
		...
		//@Autowired
		public RecruiterJobSeekerController(JobSeekerService jobSeekerService) {
			this.jobSeekerService = jobSeekerService;
		}
		
		//이력서 리스트
		@GetMapping("/list")
		public void showJobSeekerList(Model model) {
			model.addAttribute("jsList", jobSeekerService.getJobSeekerList()) ;
