...
public interface RecruiterMapper {
	...
	public void insertRecruit(@Param("bno") Long bno, @Param("btitle") String btitle,
			@Param("bcontent") String bcontent, @Param("bwriter") String bwriter, @Param("bregDate") Date bregDate,
			@Param("bendDate") Date bendDate, @Param("breplyCnt") Integer breplyCnt, @Param("bappCnt") Integer bappCnt,
			@Param("bblind") Integer bblind, @Param("boccupation") String boccupation, @Param("bregion") String bregion,
			@Param("bhcnt") Integer bhcnt);

	// 특정 구인글 수정
	public Integer updateRecruit(RecruiterVO recruiterVO);

	public Integer updateRecruit(@Param("bno") Long bno, @Param("btitle") String btitle,
			@Param("bcontent") String bcontent, @Param("bwriter") String bwriter, @Param("bregDate") Date bregDate,
			@Param("bendDate") Date bendDate, @Param("breplyCnt") Integer breplyCnt, @Param("bappCnt") Integer bappCnt,
			@Param("bblind") Integer bblind, @Param("boccupation") String boccupation, @Param("bregion") String bregion,
			@Param("bhcnt") Integer bhcnt);
